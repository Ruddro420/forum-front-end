...
export default function CvGenerate() {
  ...
  const [formData, setFormData] = useState({
    ...
    summary:
      "Passionate developer with 5+ years of experience building scalable web applications using modern JavaScript frameworks.",
  ...
  useEffect(() => {
    localStorage.setItem(
      "cvData",
      JSON.stringify({ formData, profileImage, accentColor })
    );
  ...
  return (
    <div className="flex flex-col lg:flex-row p-4 gap-6 bg-gray-50 min-h-screen">
      ...
      <div
        ref={formRef}
        className="w-full lg:w-2/5 bg-white p-6 shadow-lg rounded-lg print:hidden overflow-y-auto max-h-screen"
      >
      ...
      <div className="max-w-full overflow-x-scroll">
        <div
          className="cv-print-area bg-white p-8 shadow-lg rounded-lg"
          style={{ width: "900px", margin: "0 auto", color: "#000" }}
        >
            ...
            <div className="md:w-1/3">
              {profileImage ? (
                <img
                  src={profileImage}
                  alt="Profile"
                  className="w-40 h-40 object-cover rounded-full mx-auto md:mx-0 border-4"
                  style={{ borderColor: accentColor }}
                />
              ) : (
                <div
                  className="w-40 h-40 bg-gray-200 rounded-full mx-auto md:mx-0 flex items-center justify-center border-4"
                  style={{ borderColor: accentColor }}
                >
