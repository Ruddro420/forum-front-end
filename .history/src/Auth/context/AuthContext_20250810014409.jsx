...
export const AuthProvider = ({ children }) => {
    ...
    return (
        <AuthContext.Provider value={{ user, userPost, loading, login, logout, fetchUser, posts, stats, recentPost, fetauredTag, fetchPost, fetchUserPost,categories ,fetchTotalData}}>
            {children}
