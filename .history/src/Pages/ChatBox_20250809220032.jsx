                  ...
                  <div className={`flex max-w-xs lg:max-w-md ${isMe ? 'flex-row-reverse' : ''}`}>
                    {showAvatar && (
                      <div className={`flex-shrink-0 ${isMe ? 'ml-3' : 'mr-3'}`}>
                        {isMe ? <CircleUserRound className="w-8 h-8 rounded-full object-cover border-2 border-white shadow" /> : <ShieldUser className="w-8 h-8 rounded-full object-cover border-2 border-white shadow" />}
