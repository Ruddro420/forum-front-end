...
const Chatbox = () => {
  ...
  // Initialize Ably client once when user changes
  useEffect(() => {
  ...
  // Subscribe to channel and load messages when client and user are ready
  useEffect(() => {
    ...
    const loadMessages = async () => {
      try {
        // Your backend must return all messages where sender or receiver is currentUser.id or admin
  ...
  const sendMessage = async (e) => {
    ...
    try {
      ...
      setNewMessage('');
      // Do not add message locally; wait for subscription
    } catch (err) {
