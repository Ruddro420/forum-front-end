        ...
        <div className="flex gap-6">
          ...
          <div className="flex flex-col items-center space-y-3">
            <button
              ...
              className={`p-2 rounded-lg transition-colors ${userVote === 'up' ? 'bg-green-100 text-green-600' : 'hover:bg-gray-100 text-gray-400'
                }`}
            >
              <ArrowUp className="h-6 w-6" />
            </button>
            <span className="text-2xl font-bold text-gray-900">{post.votes?.length > 0 ? post.votes.length : 0}</span>
            <button
              onClick={() => handleVote('down')}
              className={`p-2 rounded-lg transition-colors ${userVote === 'down' ? 'bg-red-100 text-red-600' : 'hover:bg-gray-100 text-gray-400'
                }`}
            >
            ...
            <button
              ...
              className={`p-2 rounded-lg transition-colors ${isBookmarked ? 'bg-yellow-100 text-yellow-600' : 'hover:bg-gray-100 text-gray-400'
                }`}
            >
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              <div className="text-right">
                ...
                <div className="font-medium text-gray-900">{post?.student_id ? post.student_id : 'Admin'}</div>
              ...
              <div className="w-12 h-12 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center text-white font-medium">
                {post?.student_id ? post.student_id : 'A'}
              </div>
            </div>
          </div>
        </div>
