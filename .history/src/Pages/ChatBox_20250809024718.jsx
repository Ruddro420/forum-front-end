...
const Chatbox = () => {
  ...
  // Initialize Ably client when currentUser changes
  useEffect(() => {
  ...
  // Subscribe to Ably channel and listen for real-time messages
  useEffect(() => {
  ...
  }, [currentUser, ablyClientRef.current]);
  ...
  const sendMessage = async (e) => {
    ...
    try {
      ...
      setNewMessage('');
      // Do NOT add message locally; real-time subscription will add it
    } catch (err) {
